...
public class MyFragment extends Fragment {
    ...
    private void setupLoggedInView() {
        ...
        NetworkUtils.getUserInfo(getActivity(), new UserInfoCallback() {
            @Override
            public void onSuccess(String username, String nickname) {
            ...
            public void onError(String error) {
                Log.d("MyFragment", "Error fetching user info: " + error);
            }
        });
